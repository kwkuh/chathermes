      ...
      <div className="max-w-[920px] mx-auto px-5 sm:px-7 py-12 sm:py-16">
        ...
        {step === "configure" && catalogue && (
          <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="space-y-5">
            ...
            <div className="text-[12px] text-paper-faint text-center">By deploying, you agree to Hetzner's terms. ChatHermes is licensed under <a href="https://github.com/kwkuh/chathermes/blob/main/LICENSE.md" className="hover:text-paper underline">ChatHermes Open Source License</a>.</div>
          </motion.div>
        )}
