        ...
        <aside className={`fixed lg:sticky top-[57px] left-0 z-20 w-[260px] h-[calc(100vh-57px)] overflow-y-auto bg-ink border-r border-ink-line/40 transition-transform lg:translate-x-0 ${mobileNavOpen ? "translate-x-0" : "-translate-x-full"}`}>
          <nav className="px-4 py-6 space-y-6">
            ...
            <div className="pt-4 border-t border-ink-line/40">
              <a href="https://github.com/kwkuh/chathermes" target="_blank" rel="noopener" className="flex items-center gap-2 px-3 py-1.5 text-[12.5px] text-paper-dim hover:text-amber transition">
                <GitBranch size={12} />
                <span>GitHub</span>
...
// Paid user + status=pending/provisioning → falls back to shared`}</Code>
          ...
          <Section id="self-hosting" title="Self-hosting" kicker="— production checklist">
            ...
            <ul>
              <li><strong>HTTPS</strong> — set up nginx + Certbot. See <a href="https://github.com/kwkuh/chathermes/blob/main/INSTALL.md" target="_blank" rel="noopener" className="link">INSTALL.md Path 3</a>.</li>
              ...
              <li><strong>Stripe</strong> — set up products + webhook endpoint. See <a href="https://github.com/kwkuh/chathermes/blob/main/INSTALL.md" target="_blank" rel="noopener" className="link">INSTALL.md "Optional integrations"</a>.</li>
          ...
          <div className="mt-16 pt-8 border-t border-ink-line/40 flex items-center justify-between text-paper-faint text-[12.5px] font-[family-name:var(--font-mono)]">
            ...
            <a href="https://github.com/kwkuh/chathermes" target="_blank" rel="noopener" className="hover:text-amber inline-flex items-center gap-1">
