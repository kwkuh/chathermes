      ...
      <div className="mx-auto max-w-[1140px] px-5 sm:px-7 relative">
        ...
        <FadeUpOnView>
          <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-3">
            <a href="https://github.com/kwkuh/chathermes" target="_blank" rel="noopener noreferrer" className="group rounded-2xl bg-ink-soft border border-ink-line hover:border-amber/40 transition-colors px-6 py-6 flex items-start gap-4">
